      ...
      <div className="item-footer-1">
        ...
        <div className="information-wandave">
          <div className="introduce-wandave">
            <span>
              Cửa hàng CERAMIX chuyên cung cấp các thương hiệu thời trang, các
              thiết bị điện tử, trang sức đạt tiêu chuẩn chất lượng.
            </span>
          </div>
          <ul>
            <li>
            ...
            <li>
              <i className="fa-solid fa-envelope"></i> &nbsp; ceramix@gmail.com
            </li>
          </ul>
        </div>
      </div>
