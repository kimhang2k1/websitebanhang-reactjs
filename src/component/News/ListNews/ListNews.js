  ...
  return (
    <div className="blog">
      <div className="nav-blog-product">
        ...
        <ItemNews image="https://file.hstatic.net/200000389561/article/blog5_grande_0fb4c00285a64db59a6deab3bf81da93_large.jpg" />
        <ItemNews image="https://file.hstatic.net/200000389561/article/b1-min_1024x1024_a53628be99c04f71a9f72fb8c765db1c_large.jpg" />
      </div>
    </div>
  );
}
